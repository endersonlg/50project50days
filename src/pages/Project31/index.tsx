        ...
        <Settings onSubmit={generateNewPassword}>
          <div>
            ...
            <input type="number" 
              max={20} 
              min={4} 
              onChange={e=>setOptions(state=>({...state,length:Number(e.target.value)}))}
          ...
          <div>
            ...
            <input 
              type="checkbox" 
              onChange={e=>setOptions(state=>({...state,haveUppercase:e.target.checked}))}
          ...
          <div>
            ...
            <input 
              type="checkbox" 
              onChange={e=>setOptions(state=>({...state,haveLowercase:e.target.checked}))}
          ...
          <div>
            ...
            <input 
              type="checkbox" 
              onChange={e=>setOptions(state=>({...state,haveNumbers:e.target.checked}))}
          ...
          <div>
            ...
            <input 
              type="checkbox" 
              onChange={e=>setOptions(state=>({...state,haveSymbols:e.target.checked}))}
