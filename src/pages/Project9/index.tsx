...
export function Project9() {
  ...
  return (
    <ContainerProject9>
      <div>
        <button type="button" onClick={() => playAudio('applause')}>
          applause
        </button>
        <button type="button" onClick={() => playAudio('boo')}>
          boo
        </button>
        <button type="button" onClick={() => playAudio('gasp')}>
          gasp
        </button>
        <button type="button" onClick={() => playAudio('tada')}>
          tada
        </button>
        <button type="button" onClick={() => playAudio('victory')}>
          victory
        </button>
        <button type="button" onClick={() => playAudio('wrong')}>
          wrong
        </button>
      </div>
    </ContainerProject9>
